...
for (i in 1:length(up_av_expr)) {
  sel = which(up_av_expr_de[[i]]$adj.P.Val<2)
  if (length(sel)>0) {
...
for (i in 1:length(down_av_expr)) {
  sel = which(down_av_expr_de[[i]]$adj.P.Val<2)
  if (length(sel)>0) {
    for (j in 1:length(sel)) {
...
### Save results
saveRDS(allresup, str_c(here("Res/ThirdSubmission/Mediation"),"/Up_1KI_parallel_All.rds"))
saveRDS(allresdown, str_c(here("Res/ThirdSubmission/Mediation"),"/Down_1KI_parallel_All.rds"))
...
### Save results
saveRDS(allresup, str_c(here("Res/ThirdSubmission/Mediation"),"/Up_Without_1KI_parallel_All.rds"))
saveRDS(allresdown, str_c(here("Res/ThirdSubmission/Mediation"),"/Down_Without_1KI_parallel_All.rds"))
