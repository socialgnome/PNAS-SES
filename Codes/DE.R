...
#### omnibus test for all subjects. Also doubles for the DE for DeNovo

#### Prerequisites: 1. BioMart Download of gene symbols

#### Follow up files: 1. OmnibusTest_FigS1A.R and 2.DeNovo_Analysis.R
...
for (i in 1:length(treatment)) {
  ...
  saveRDS(res, str_c(here("Res/ThirdSubmission/DE/"), treatment[[i]],".rds"))
}
