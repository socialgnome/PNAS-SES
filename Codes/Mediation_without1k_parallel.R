...
res = readRDS("Z:/Projects/PNAS/Res/ThirdSubmission/Clustering/Without_1KI.rds")

## Load expression data
dat = readRDS("Z:/Projects/PNAS/data/Filtered_ExpressionSet_Clustering_SelSubData.rds")
...
### Save results
saveRDS(allresup, "Z:/Projects/PNAS/Res/ThirdSubmission/Mediation/Up_Without_1KI_parallel.rds")
saveRDS(allresdown, "Z:/Projects/PNAS/Res/ThirdSubmission/Mediation/Down_Without_1KI_parallel.rds")